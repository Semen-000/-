...
class App(tk.Tk):
    ...
    def start_screen(self):
        for widget in self.winfo_children():
            widget.destroy()
        tk.Label(self, text="Последние минуты", font=("Arial", 28, "bold"), fg="#4A90E2", bg="#2b2b2b").pack(pady=30)
